...
const instructionsByMode: Record<AiReviewMode, AiReviewDataV01['instructions']> = {
  consult: {
    ...
    proposalRule: 'When replacementText is present, treat it as the exact replacement text proposed by the human, not as a mandatory replacement. An empty replacementText represents the human\'s proposal to delete the target text.',
  ...
  revise: {
    ...
    sourceContentRule: SOURCE_CONTENT_RULE,
    reviewRule: REVIEW_RULE,
    proposalRule: 'When replacementText is present, treat it as the exact replacement text proposed by the human. You may use a better alternative when appropriate. An empty replacementText represents the human\'s proposal to delete the target text.',
    toolUseRule: TOOL_USE_RULE,
